	...
	<div class="recipient_reg" style="background-color:#272327;">
		...
		<form enctype="multipart/form-data" action=""  method="post" class="text-center" style="margin-left: 110px">
			 <div class="col-md-12">
					...
					<label>
						 <input type="text" name="contact" value="" placeholder="Phone Number" >
					</label><br><br>
					...
					<?php  
						 if(isset($_POST['submit'])){
							...
							if(move_uploaded_file($_FILES["pic"]["tmp_name"], $target_file)) {
									...
									$sql = "INSERT INTO doctor (name,phone_number,email,expertise,userid,fee,password,pic)
										VALUES ('" . $_POST["name"] . $_POST["contact"] . "','" . $_POST["email"] . "', '" . $_POST["expertise"] . "','" . $_POST["userid"] . "','" . $_POST["fee"] . "','" . $_POST["password"] . "','" . basename($_FILES["pic"]["name"]) ."' )";
