...
$query="select * from tuberculosis limit 3";

$rs=mysqli_query($cn,"select * from tuberculosis where symptom_type='peculiar' limit 3 ");
...
{	
		if($submit=='Next Question' && isset($ans))
		{
				...
				mysqli_query($cn, "insert into answer(user_id,symptom_type,symptom,true_ans,your_ans) values ($user_id,'$row[1]','$row[2]',
					'$row[5]','$ans')");
				if($ans==$row[5])
				{
